...
mod tests {
    ...
    fn test_soroban_create_group_ordering_and_flush_boundaries() {
        ...
        let changes = build_entry_changes_with_hot_archive(
            ...
            &LedgerChanges {
                created: &created,
                updated: std::slice::from_ref(&update_post),
                update_states: std::slice::from_ref(&update_pre),
                deleted: std::slice::from_ref(&delete_key),
                delete_states: std::slice::from_ref(&delete_pre),
