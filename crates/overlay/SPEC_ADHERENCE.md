...
- **Notes**: Both divergences are non-consensus-affecting — they only influence connection churn timing under out-of-sync conditions. The core mechanism (cooldown → random non-preferred drop) is implemented correctly.
