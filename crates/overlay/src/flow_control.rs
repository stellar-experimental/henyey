...
impl Default for FlowControlConfig {
    fn default() -> Self {
        Self {
            ...
            flow_control_bytes_batch_size: 100_000, // 100 KB (spec: OVERLAY_SPEC §8.4)
        }
    }
}
...
mod tests {
    ...
    // ── OVERLAY_SPEC §14.3: FlowControl default constants ──────────
    ...
    fn test_default_config_byte_batch_size_is_100k() {
        ...
        assert_eq!(
            ...
            "OVERLAY_SPEC §8.4: byte batch size must be 100,000"
        );
    }
