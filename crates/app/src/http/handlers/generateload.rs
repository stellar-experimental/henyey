...
mod tests {
    ...
    fn apply_load_request_defaults() -> LoadGenRequest {
        LoadGenRequest {
            ...
            ledger_max_instructions: None,
            ledger_max_read_bytes: None,
            ledger_max_write_bytes: None,
            ledger_max_read_ledger_entries: None,
            ledger_max_write_ledger_entries: None,
            ledger_max_tx_count: None,
            ledger_max_transactions_size_bytes: None,
            tx_max_instructions: None,
            tx_memory_limit: None,
            tx_max_read_bytes: None,
            tx_max_write_bytes: None,
            tx_max_read_ledger_entries: None,
            tx_max_write_ledger_entries: None,
            tx_max_size_bytes: None,
            tx_max_contract_events_size_bytes: None,
            max_contract_size_bytes: None,
            max_contract_data_key_size_bytes: None,
            max_contract_data_entry_size_bytes: None,
            tx_max_footprint_entries: None,
        }
    }
