...
use crate::{
    ...
    eviction::{EvictionIterator, EvictionResult},
...
impl crate::eviction_scan::EvictionScanSource for BucketListSnapshot {
    ...
    fn eviction_lookup(&self, key: &LedgerKey) -> crate::Result<Option<LedgerEntry>> {
        self.get_result(key)
    }
}
...
impl BucketListSnapshot {
    ...
    pub fn scan_for_eviction_incremental(
        ...
        crate::eviction_scan::scan_for_eviction_incremental(self, iter, current_ledger, settings)
    }
}
